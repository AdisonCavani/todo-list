...
async function Layout({ children }: PropsWithChildren) {
  ...
  return (
    <>
      <header className="sticky top-0 z-10 mr-[calc(var(--removed-body-scroll-bar-size)*(-1))] flex w-[-webkit-fill-available] items-center justify-between border-b bg-blue-600 py-2 pl-4 pr-[calc(24px+var(--removed-body-scroll-bar-size,0px))] dark:bg-neutral-800">
